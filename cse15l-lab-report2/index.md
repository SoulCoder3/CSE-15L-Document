...
## Part 2
1. The path to the private key for my SSH key on my computer. id_rsa is my private SSH key and id_rsa.pub is my public SSH key. The known_hosts contains the key of the hosts I am trusting.
![Image](lab2.4.png)
2. The path to the public key for my SSH key on ieng6. Since I copy the public SSH key to ieng6 server, the file called authorized_keys is the public SSH key.
![Image](lab2.6.png)
